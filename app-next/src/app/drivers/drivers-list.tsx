  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-2xl mx-auto px-4 py-6">
        ...
        <form
          onSubmit={handleAdd}
          className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 mb-4 flex flex-col sm:flex-row gap-2"
        >
          <Input
            ...
            >
              ...
              <span
                className={`text-xs px-2 py-0.5 rounded ${
                  driver.is_active ? "bg-emerald-100 text-emerald-700" : "bg-slate-100 text-slate-400"
                }`}
              >
